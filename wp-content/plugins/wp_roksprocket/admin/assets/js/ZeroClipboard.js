 ...
 */
((function(){var a="ZeroClipboard"+(Browser.Plugins.Flash&&Browser.Plugins.Flash.version>=10?"10":"")+".swf";this.ZeroClipboard={version:"1.0.7",clients:{},moviePath:"/wp-content/plugins/wp_roksprocket/admin/assets/js/"+a,nextId:1,$:function(b){return document.id(b)||document.getElement(b)||null;

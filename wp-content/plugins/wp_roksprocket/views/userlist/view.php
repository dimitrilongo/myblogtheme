...
class RokSprocket_Views_Userlist_View implements RokSprocket_Views_IView
{
    ...
    public function __construct($instance = null)
    {
        ...
        $this->base_link = get_bloginfo('wpurl') . '/wp-admin/admin-ajax.php?action=roksprocket_userlist&nonce=' . $this->nonce;
        ...
        $user_args['number'] = 20;
        $user_args['offset'] = ($this->paged - 1) * 20;

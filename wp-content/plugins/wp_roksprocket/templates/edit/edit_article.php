...
<div class="article<?php echo $class?>" data-article-id="<?php echo $article->getArticleId();?>">
	...
	foreach ($item_fieldsets as $name => $fieldSet):?>
		<ul class="item-params">
			...
			<li class="<?php //echo $type; ?>">
				<span class="input-name sprocket-tip" data-original-title="<?php echo rc__($field->description); ?>"><?php echo $field->title; ?></span>

        ...
        <tr class="<?php echo (($j % 2 == 0) ? 'alternate ' : '');?>iedit">
            <td>
                <a class="article-link"
                   ...
                   onclick="if (window.parent) window.parent.jSelectUser_Sprocket('<?php echo $post->ID; ?>', '<?php echo $post->post_title;?>', '<?php echo $post->ID; ?>', null, '<?php echo get_permalink($post->ID); ?>', '', null);">

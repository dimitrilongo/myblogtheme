 ...
 * @version 1.0
 */
class RokTwittie_FileCacheDriver implements RokTwittie_CacheDriver
{
	 ...
	 * @var string
	 */
	protected $dir = ROKTWITTIE_CACHE;
	...
	public function __construct($dir=NULL)
	{
		...
		else if(!$this->checkDirectory($this->dir)) throw new RokTwittie_CacheException('Unable to use given directory. Check file permissions.');
	}

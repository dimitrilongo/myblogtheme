...
class RokTwittie_Cache
{
	 ...
	 * @return boolean
	 */
	public function addDriver($name, RokTwittie_CacheDriver $driver, $default = TRUE)
	{
	...
	protected function getDriver($name=NULL){
		...
		throw new RokTwittie_CacheException('No driver strategy set!');
	}
	...
	public function set($groupName, $identifier,  $data, $driver = NULL)
	{
		...
		catch (RokTwittie_CacheException $e){
	...
	{
		try{
			if(!(is_numeric($lifeTime) && $lifeTime>0)) $lifeTime=$this->defaultLifeTime;
...
class RokTwittie_CacheException extends Exception {

...
class RokGallery_Widgets_RokGallery extends WP_Widget
{
    ...
    function form($instance)
    {
        ...
        ob_start();
        echo RokCommon_Composite::get('wp_forms.widget')->load('widget_form.php', array('instance' => $instance));
        echo ob_get_clean();
    }
    ...
    function render($args, $instance)
    {
        ...
        echo RokCommon_Composite::get('wp_views.widget')->load('default.php', array('view' => $view));

...
class RokGallery_Metaboxes_Posttype
{
    ...
    function add_metabox()
    {
        ...
        RokCommon_Header::addStyle(RokCommon_Composite::get('wp_assets.styles')->getUrl('tabs.css'));
    ...
    {
        global $post, $rokgallery_plugin_url;
        ...
        ob_start();
        echo RokCommon_Composite::get('wp_forms')->load('posttype_form.php', array('instance' => $instance));
        echo ob_get_clean();
    }
}

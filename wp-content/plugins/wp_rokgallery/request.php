...
class RokGallery_Request
{
    ...
    {
        $value = is_array($value) ? array_map(array('RokGallery_Request', '_stripSlashesRecursive'), $value) : stripslashes($value);
        return $value;
    }

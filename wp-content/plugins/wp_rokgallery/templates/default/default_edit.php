...
$link = get_bloginfo('wpurl').'/wp-admin/admin-ajax.php?action=rokgallery_postlist&nonce='.$nonce.'&TB_iframe=true&height=555&width=555&modal=false';
?>
<div id="file-edit">
		...
		<div class="info edit-block">
			<div class="column">
				...
				<div class="link">
                    ...
                    <a class="thickbox modal link-select-article" title="Select or Change Article" href="<?php echo $link; ?>"><span><?php rc_e('ROKGALLERY_SELECT_ARTICLE');?></span></a>
				</div>
				<div class="clr"></div>
			</div>
			<div class="column">

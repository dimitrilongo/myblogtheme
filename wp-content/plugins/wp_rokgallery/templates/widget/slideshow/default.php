...
<div id="rg-<?php echo $passed_params->moduleid; ?>" class="rokgallery-wrapper">
    <div class="rg-ss-container">
        <div class="rg-ss-slice-container"
             style="width:<?php echo $passed_params->image_width;?>px;height:<?php echo $passed_params->image_height;?>px;">
        ...
        <div class="rg-ss-navigation-container arrows-enabled"
             style="width:<?php echo $passed_params->image_width;?>px;">
                    ...
                    <ul class="rg-ss-thumb-list">
                        ...
                        <li>
                            ...
                            <div class="rg-ss-thumb">
                                <img title="<?php echo $slice->title;?>" alt="<?php echo $slice->title;?>"
                                     src="<?php echo $slice->thumburl;?>"
                                     width="<?php echo $passed_params->thumb_width;?>"
                                     height="<?php echo $passed_params->thumb_height;?>"/>
                            </div>
                            <?php endif; $i++;?>
                        </li>
                        <?php endforeach;?>

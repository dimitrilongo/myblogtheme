...
<div id="rg-<?php echo $passed_params->moduleid; ?>"
     class="rg-sc layout-<?php echo $passed_params->showcase_image_position; ?>">
    <div class="rg-sc-main" style="height: <?php echo $container_size['height']; ?>;">
        <div class="rg-sc-slide" style="height: <?php echo $container_size['height']; ?>;">
            <div class="rg-sc-slice-container"
                 style="width: <?php echo $container_size['width']; ?>;height: <?php echo $container_size['height']; ?>;">
                <div class="rg-sc-img-padding" style="padding: <?php echo $passed_params->showcase_imgpadding; ?>px;">
                    <div class="rg-sc-img-list"
                         style="width: <?php echo $slices_size['width']; ?>px;height: <?php echo $slices_size['height']; ?>px;">
		                ...
		                <?php endif;?>
                            <img title="" alt="<?php echo $slice_title;?>" src="<?php echo $slice->imageurl;?>"
                                 width="<?php echo $passed_params->image_width;?>"
                                 height="<?php echo $passed_params->image_height;?>"/>
                            <?php if ($passed_params->link != 'none'): ?>
		            		</a>
		            	<?php endif;?>
                        </div>
            ...
            <?php if (($passed_params->show_title) || ($passed_params->caption)): ?>
            <div class="rg-sc-content"
                 style="margin-<?php echo $passed_params->showcase_image_position;?>: <?php echo $container_size['width']; ?>;">
                <?php foreach ($passed_params->slices as $slice): ?>
                <?php
                ...
                <div class="rg-sc-info">
                    <?php if ($passed_params->show_title): ?>

...
//
?>
<?php if ($that->field_id): ?>
<script type="text/javascript">
	window.addEvent('domready', function(){
        window.Popup.select = function(id, title, object) {
            window.parent.document.getElementById('<?php echo $that->field_id; ?>_id').value = id;
            window.parent.document.getElementById('<?php echo $that->field_id; ?>_name').value = title;
            window.Popup.close();
        };
    });
</script>

    ...
    function render($params = array()) {
        ...
        <div id="comments" class="comments-standard">
        	...
        	<div class="comments-title">
        		<h3><?php comments_number(_r('0 Comments'), _r('1 Comment'), _r('% Comments')); ?></h1>
            </div>
        ...
        <div id="respond">
			...
			<div class="comments-title">
	            <h3><?php comment_form_title(_r('Leave a Reply'), _r('Leave a Reply to %s')); ?></h3>
			</div>
            ...
            <?php else : ?>
                ...
                <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="comments-form" onsubmit="if(url.value=='<?php _re('Website'); ?>') url.value='';">
                    ...
                    <?php else : ?>
                        ...
                        <p>
                            <input type="text" name="author" id="author" class="inputbox" onblur="if(this.value=='') this.value='<?php _re('Name (Required)'); ?>';"
                        ...
                        <p>
                            <input type="text" name="email" id="email" class="inputbox" onblur="if(this.value=='') this.value='<?php _re('E-mail (Required)'); ?>';"
                        ...
                        <p>
                            <input type="text" name="url" id="url" class="inputbox" onblur="if(this.value=='') this.value='<?php _re('Website'); ?>';"
                            	   onfocus="if(this.value=='<?php _re('Website'); ?>') this.value='';" value="<?php _re('Website'); ?>" size="22" tabindex="3" />
                        </p>
